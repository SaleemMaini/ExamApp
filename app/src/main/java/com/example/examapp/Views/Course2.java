 ...
 * Use the {@link Course2#newInstance} factory method to
...
public class Course2 extends Fragment {
     ...
     * @return A new instance of fragment Course2.
     */
    // TODO: Rename and change types and number of parameters
    public static Course2 newInstance(String param1, String param2) {
        Course2 fragment = new Course2();
...
//        course2QuestionList.add(new Data_Question("2222",90));
        ...
        databaseHelper1 = new DatabaseHelper1(getActivity());
         recyclerViewAdapter = new RecyclerViewAdapter(getActivity(),databaseHelper1.getCourse2Questions(),databaseHelper1);
