...
//    public void create() {
//        try {
//            new DatabaseHelper1(getActivity()).execSQL("CREATE TABLE  IF NOT EXISTS " + "student"  +" ("
...
//        Cursor cursor = new DatabaseHelper1(getActivity()).getData("SELECT * FROM student WHERE username='" + username + "' AND password='" + password + "'");
...
//        return new DatabaseHelper1(getActivity()).insertData("student", values);
//    }
//    public long updateData(String TableName, ContentValues values, String where, String[] whereAr){
//        return new DatabaseHelper1(getActivity()).updateData("student", values, where, whereAr);
//
//    }
//
//    public List<Data_Student> getAllStudent() {
//        Cursor cursor = new DatabaseHelper1(getActivity()).getData("SELECT * FROM student;");
//
...
//        Cursor cursor = new DatabaseHelper1(getActivity()).getData("SELECT * FROM student WHERE name='" + Name + "';");
